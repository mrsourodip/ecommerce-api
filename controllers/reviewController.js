...
const getSingleReview = async(req, res) => {
    ...
    if(!review) throw new CustomError.NotFoundError(`No review found with id: ${reviewId}`)
...
module.exports = { createReview, getAllReviews, getSingleReview, updateReview, deleteReview, getSingleProductsReview }